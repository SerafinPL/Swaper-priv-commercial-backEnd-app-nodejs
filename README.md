...
- ✅ calculate 'indicator 3' form clines kraken data. 
...
- ✅ expand API to make purchase by client app with more than one exchanges. 
...
- ✅ make API to make purchase by client app 
